...
Base.convert(::Type{T},x::VaxInt16) where T <: Union{Int32,Int64,Int128,AbstractFloat} = convert(T,convert(Int16,x))

Base.promote_rule(::Type{Int8},::Type{VaxInt16}) = Int16
Base.promote_rule(::Type{T},::Type{VaxInt16}) where T <: Union{Int16,Int32,Int64,Int128,AbstractFloat} = T
...
Base.promote_rule(::Type{T},::Type{VaxInt32}) where T <: Union{Int8,Int16} = Int32
